...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'imdigi', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '因阅读和记录而改变了点什么，所以始终保留一块自留地。 @杭州', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.imdigi.com', // 网站地址
